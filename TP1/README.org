...
* Exercices
  ...
  - *1.c*: This code calculates the number of iterations necessary to converge using the Collatz conditions. You have Convert the '*collatz*' function into its equivalent in x86 assembly.
